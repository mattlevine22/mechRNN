...
srun --exclusive -N 1 -n 1 python ../scripts/run_script_2dOscillator_SCRIPTSTYLE.py --savedir 2dOsc/one_epoch_VeryHighFreq_Short --epoch 1 --delta_t 0.001 --t_end 100 --train_frac 0.8 &
