...
srun --exclusive -N 1 -n 1 python ../scripts/run_script_2dOscillator_SCRIPTSTYLE_simple.py --savedir 2dOscillator_run1/loop --epoch 200 --delta_t 0.1 --t_end 100 --train_frac 0.9 &
