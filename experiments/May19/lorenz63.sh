...
srun --exclusive -N 1 -n 1 python ../scripts/run_script_lorenz63_SCRIPTSTYLE.py --savedir lorenz63/loop_1000epochs --epoch 1000 --delta_t 0.01 --t_end 100 --train_frac 0.9
srun --exclusive -N 1 -n 1 python ../scripts/run_script_lorenz63_SCRIPTSTYLE.py --savedir lorenz63/loop_1000epochs_slower --epoch 1000 --delta_t 0.05 --t_end 100 --train_frac 0.9
srun --exclusive -N 1 -n 1 python ../scripts/run_script_lorenz63_SCRIPTSTYLE.py --savedir lorenz63/loop_1000epochs_slower_longer --epoch 1000 --delta_t 0.05 --t_end 1000 --train_frac 0.99
wait