...
# srun --exclusive -N 1 -n 1 python ../scripts/run_script_2dOscillator_SCRIPTSTYLE_simple.py --savedir 2dOscillator_run1/loop_0.8_5000 --epoch 5000 --delta_t 0.1 --t_end 100 --train_frac 0.8
srun --exclusive -N 1 -n 1 python ../scripts/run_script_2dOscillator_SCRIPTSTYLE_simple.py --savedir 2dOscillator_run1/oneEpoch_10x --epoch 1 --delta_t 0.1 --t_end 20000 --train_frac 0.999
