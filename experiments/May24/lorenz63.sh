...
srun --exclusive -N 1 -n 1 python ../scripts/run_script_lorenz63_SCRIPTSTYLE.py --savedir lorenz63/loop_10000epochs_perturbTrivial --epoch 10000 --delta_t 0.1 --t_end 100 --train_frac 0.9 &
wait