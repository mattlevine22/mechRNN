...
python ../scripts/lorenz63_3dvar_generateData.py --n_trajectories 10 --output_dir /groups/astuart/mlevine/Sep30/3DVAR_learning_no_cheat_50_sweep1 --output_filename TestData.npz --t_end 5
