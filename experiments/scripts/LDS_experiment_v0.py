...
CMD_run_fits = 'python3 $HOME/mechRNN/experiments/scripts/reproduce_dima_wrapper_LDS.py'

OUTPUT_DIR = '/groups/astuart/mlevine/writeup0/reproduce_dima_sweep/LDS/experiment0'
