...
srun --exclusive -N 1 -n 1 python3 reproduce_dima.py --output_dir /groups/astuart/mlevine/writeup0/reproduce_dima/dt0.001/eps1/tSynch50_tInvMeas100_nGpSub800 --eps 1 --delta_t 0.001 --K 9 --J 8 --F 10 --t_synch 50 --t_train 10 --t_invariant_measure 100 --n_subsample_gp 800 &
srun --exclusive -N 1 -n 1 python3 reproduce_dima.py --output_dir /groups/astuart/mlevine/writeup0/reproduce_dima/dt0.001/eps1/tSynch500_tInvMeas2000_nGpSub800 --eps 1 --delta_t 0.001 --K 9 --J 8 --F 10 --t_synch 500 --t_train 10 --t_invariant_measure 2000 --n_subsample_gp 800 &
srun --exclusive -N 1 -n 1 python3 reproduce_dima.py --output_dir /groups/astuart/mlevine/writeup0/reproduce_dima/dt0.001/eps10/tSynch50_tInvMeas100_nGpSub800 --eps 10 --delta_t 0.001 --K 9 --J 8 --F 10 --t_synch 50 --t_train 10 --t_invariant_measure 100 --n_subsample_gp 800 &
srun --exclusive -N 1 -n 1 python3 reproduce_dima.py --output_dir /groups/astuart/mlevine/writeup0/reproduce_dima/dt0.001/eps10/tSynch500_tInvMeas2000_nGpSub800 --eps 10 --delta_t 0.001 --K 9 --J 8 --F 10 --t_synch 500 --t_train 10 --t_invariant_measure 2000 --n_subsample_gp 800
wait
