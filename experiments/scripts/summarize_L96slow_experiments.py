...
from summarizers import compare_performance_bar_chart
...
def main():
	...
	# 		my_dirs.append(x)
	if len(my_dirs):
		compare_performance_bar_chart(my_dirs,output_fname=pathname+'/compare_epsilons',ignore_flow=FLAGS.ignore_flow)
