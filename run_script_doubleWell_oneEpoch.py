...
state_init = [3]
(a, b, c) = [1, 1, 0]
sim_model_params = {'state_names': ['u'], 'state_init':state_init, 'delta_t':delta_t, 'ode_params':(a, b, c)}
rnn_model_params = {'state_names': ['u'], 'state_init':state_init, 'delta_t':delta_t, 'ode_params':(a, b, c)}

sim_model = double_well
rnn_sim_model = double_well
...
for i in range(n_sims):
	...
	output_dir = 'doubleWell_1Epoch_output/experiment1/sim' + str(i+1)
	...
	for eps_badness in [0.05]:
		rnn_BAD_model_params = {'state_names': ['u'], 'state_init':state_init, 'delta_t':delta_t, 'ode_params':(a, b*(1+eps_badness), c)}
